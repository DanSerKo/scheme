...
public:
    Interpreter() {
        ...
        AddProcessing("define", Define);
        AddProcessing("set!", Set);
        AddProcessing("set-car!", SetCar);
        AddProcessing("set-cdr!", SetCdr);
    }
...
private:
    ...
    friend std::shared_ptr<Object> Define(std::shared_ptr<Object> node, Interpreter* interpreter);
    friend std::shared_ptr<Object> Set(std::shared_ptr<Object> node, Interpreter* interpreter);
    friend std::shared_ptr<Object> SetCar(std::shared_ptr<Object> node, Interpreter* interpreter);
    friend std::shared_ptr<Object> SetCdr(std::shared_ptr<Object> node, Interpreter* interpreter);

    void AddProcessing(const std::string& s, MakeOp func);
    std::map<std::string, MakeOp> proccessings_;
    std::map<std::string, std::shared_ptr<Object>> defined_;
};
